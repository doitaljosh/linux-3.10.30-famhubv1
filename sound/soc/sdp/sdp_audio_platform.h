...
#define SDP_MONO		1
#define SDP_STEREO		2
#define SDP_MAX_CAP		5

#define SDP_MIN_RATE		8000
#define SDP_MAX_RATE		48000
#define SDP_MIN_CHANNEL		1
#define SDP_MAX_CHANNEL		2
#define SDP_MAX_BUFFER		16*1024 //16*1024//64*1024 //524288//(196608)
#define SDP_MIN_BUFFER		16*1024 //16*1024//64*1024 //524288//(196608)
#define SDP_MIN_PERIOD_BYTES	1024//1024//1024//768
#define SDP_MAX_PERIOD_BYTES	1024//1024//2048//768
#define SDP_MIN_PERIODS		16//16//32//256
#define SDP_MAX_PERIODS		16//16//64//512
#define SDP_FIFO_SIZE		0

#define SDP_RATES (SNDRV_PCM_RATE_48000 | SNDRV_PCM_RATE_44100 | SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_16000 | SNDRV_PCM_RATE_32000 | SNDRV_PCM_RATE_22050 )
#define SDP_FORMATS (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_U16_LE | SNDRV_PCM_FMTBIT_S8 | SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_U24_LE | SNDRV_PCM_FMTBIT_S32_LE | SNDRV_PCM_FMTBIT_U32_LE)

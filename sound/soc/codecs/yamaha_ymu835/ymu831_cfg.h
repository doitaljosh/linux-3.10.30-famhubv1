...
#define	BUS_SELECT		BUS_SEL_SLIM
#else
#define	BUS_SELECT		BUS_SEL_SPI
//#define	BUS_SELECT		BUS_SEL_I2C
#endif
...
#if (defined(CONFIG_SND_SOC_MSM8960) || defined(CONFIG_SND_SOC_MSM8974))
#define	MUSIC_PHYSICAL_PORT	MC_ASOC_PHYS_SLIM0
#else
#define	MUSIC_PHYSICAL_PORT	MC_ASOC_PHYS_DIO0
#endif
#define	EXT_PHYSICAL_PORT	MC_ASOC_PHYS_DIO1
#define	VOICE_PHYSICAL_PORT	MC_ASOC_PHYS_DIO2
#if (defined(CONFIG_SND_SOC_MSM8960) || defined(CONFIG_SND_SOC_MSM8974))
#define	HIFI_PHYSICAL_PORT	MC_ASOC_PHYS_SLIM0
#else
...
#define	IRQ_TYPE		IRQ_TYPE_EDGE_RISING

#define	AUTO_POWEROFF_OFF	(0)
#define	AUTO_POWEROFF_ON	(1)
#define	AUTO_POWEROFF		AUTO_POWEROFF_ON

#define	MIXER_ADD_DEL_MODE	MIXER_ADD_DEL_MODE_OFF
#define	MIXER_ADD_DEL_MODE_OFF	(0)
#define	MIXER_ADD_DEL_MODE_ON	(1)

#define	HSDET_USE

/*#define DEVICE_TREE_USE*/
...
static const struct mc_asoc_setup mc_asoc_cfg_setup = {
	/*	init	*/
	{
		...
		MCDRV_CKINPUT_CLKI1_RTCK,	/*	bCkInput	*/
		5,				/*	bPllModeA	*/
		7,				/*	bPllPrevDivA	*/
		84,				/*	wPllFbDivA	*/
		0,				/*	wPllFracA	*/
		...
		MCDRV_MBSEL_20,			/*	bMbSel1		*/
		MCDRV_MBSEL_20,			/*	bMbSel2		*/
		MCDRV_MBSEL_20,			/*	bMbSel3		*/
		MCDRV_MBSEL_20,			/*	bMbSel4		*/
	...
	{
		{
			...
			MCDRV_SCKMSK_OFF,
			MCDRV_SPMN_OFF_9,
			0x03, 0x30, 0x30, 0x21, 0x03, 0x00, 0x6B, 0x00,
...
static const char * const firmware_name[]	= {
	...
	"aec_ae.dat",
	"aec_bdsp_0.dat",
	"ym5_control_path_off.dat",	/* 35 */
	"ym5_config_vbox.dat",
	"ym5_line1_dac0.dat",
	"aec_vbox_fdsp.dat",
	"aec_fdsp_all.dat",
	"ym5_control_path_resume.dat",	/* 40 */
	"mach5vts.dat",
	"ym5_vts_vbox.dat",
	"ym5_vts_fifo.dat",
	"ym5_vts_param.dat",	/* 44 */
	"aec_all_in_one.dat",
	"aec_cdsp_pcmdump.dat",
	"aec_cdsp_pcmdump_fifo.dat", 	/* 47 */
	"aec_bdsp_voice.dat" 	/* 48 */
};

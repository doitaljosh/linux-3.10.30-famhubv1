...
static void InitCore(void)
{
	...
	gsFdspInfo.bAdoCSel0 = MCI_ADOCSEL0_DEF;
	gsFdspInfo.bAdoCSel1 = MCI_ADOCSEL1_DEF;
	gsFdspInfo.bAdoCSel2 = MCI_ADOCSEL2_DEF;
	gsFdspInfo.bAdoCSel3 = MCI_ADOCSEL3_DEF;
	gsFdspInfo.bAdoCSel4 = MCI_ADOCSEL4_DEF;
	gsFdspInfo.bAdoCSel5 = MCI_ADOCSEL5_DEF;
	gsFdspInfo.bAdoCSel6 = MCI_ADOCSEL6_DEF;
	gsFdspInfo.bAdoCSel7 = MCI_ADOCSEL7_DEF;
	...
	McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL0),
						gsFdspInfo.bAdoCSel0);

	McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL1),
						gsFdspInfo.bAdoCSel1);

	McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL2),
						gsFdspInfo.bAdoCSel2);

	McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL3),
						gsFdspInfo.bAdoCSel3);

	McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL4),
						gsFdspInfo.bAdoCSel4);

	McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL5),
						gsFdspInfo.bAdoCSel5);

	McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL6),
						gsFdspInfo.bAdoCSel6);

	McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL7),
						gsFdspInfo.bAdoCSel7);
	McDevIf_ExecutePacket();
...
static SINT32 SetFdspCtrl(UINT8 bDSPCtl)
{
	...
	if ((bDSPCtl & MCB_DSPSTART) != MCB_DSPSTART) {
		...
		if (machdep_GetKPrm(KPrm, sizeof(KPrm)) != 0) {
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_FORCE_WRITE
				| MCDRV_PACKET_REGTYPE_F | 84), KPrm[0]);
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_FORCE_WRITE
				| MCDRV_PACKET_REGTYPE_F | 85), KPrm[1]);
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_FORCE_WRITE
				| MCDRV_PACKET_REGTYPE_F | 86), KPrm[2]);
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_FORCE_WRITE
				| MCDRV_PACKET_REGTYPE_F | 87), KPrm[3]);
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_FORCE_WRITE
				| MCDRV_PACKET_REGTYPE_F | 88), KPrm[4]);
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_FORCE_WRITE
				| MCDRV_PACKET_REGTYPE_F | 89), KPrm[5]);
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_FORCE_WRITE
				| MCDRV_PACKET_REGTYPE_F | 90), KPrm[6]);
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_FORCE_WRITE
				| MCDRV_PACKET_REGTYPE_F | 91), KPrm[7]);
		}
		OChSel[0] = gsFdspInfo.bAdoCSel0;
		OChSel[1] = gsFdspInfo.bAdoCSel1;
		OChSel[2] = gsFdspInfo.bAdoCSel2;
		OChSel[3] = gsFdspInfo.bAdoCSel3;
		OChSel[4] = gsFdspInfo.bAdoCSel4;
		OChSel[5] = gsFdspInfo.bAdoCSel5;
		OChSel[6] = gsFdspInfo.bAdoCSel6;
		OChSel[7] = gsFdspInfo.bAdoCSel7;
		if (machdep_GetOChSel(OChSel, sizeof(OChSel)) != 0) {
			McDevIf_AddPacket((MCDRV_PACKET_TYPE_WRITE
						| MCDRV_PACKET_REGTYPE_F
						| (UINT32)MCI_ADOCSEL0),
						OChSel[0]);
...
void McFdsp_IrqProc(void)
{
	...
	if ((bIReq & MCB_IRFW_APP) == MCB_IRFW_APP) {
		...
		if (gsFdspInfo.bAppIEnb1 != 0) {
			...
			bIReqApp1 = (UINT8)(bIReqApp1 & gsFdspInfo.bAppIEnb1);
		}

...
static void NewPath(struct MCDRV_BDSP_AEC_BDSP_INFO *psBdspInfo)
{
	...
	case BDSP_PATH_DONTCARE:
		bAEBypass &= ~(psBdspInfo->bStoppedBypass & MCB_AEBYPASS_AE0);
		break;
	...
	case BDSP_PATH_DONTCARE:
		bAEBypass &= ~(psBdspInfo->bStoppedBypass & MCB_AEBYPASS_AE1);
		break;

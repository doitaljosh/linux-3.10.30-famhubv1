...
/* Undefine every CPU specific FPU optimization because it cannot be used in Kernel */
#undef SBC_BUILD_WITH_MMX_SUPPORT
#undef SBC_BUILD_WITH_ARMV6_SUPPORT
#undef SBC_BUILD_WITH_IWMMXT_SUPPORT
#undef SBC_BUILD_WITH_NEON_SUPPORT

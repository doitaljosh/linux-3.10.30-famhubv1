/*
 *  drivers/cpufreq/cpufreq_foxp.c
 *
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_FOXP
static struct cpufreq_governor cpufreq_gov_foxp;
#endif
...
static void foxp_powersave_bias_init_cpu(int cpu)
{
...
static void foxp_powersave_bias_init(void)
{
	int i;
	for_each_online_cpu(i) {
		foxp_powersave_bias_init_cpu(i);
	}
}
		...
		unsigned int new_rate)
{
	...
	for_each_online_cpu(cpu) {
		...
		if (!policy)
			continue;
		if (policy->governor != &cpufreq_gov_foxp) {
...
static struct od_ops od_ops = {
	.powersave_bias_init_cpu = foxp_powersave_bias_init_cpu,
...
static
#endif
struct cpufreq_governor cpufreq_gov_foxp = {
	.name			= "foxp",
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_foxp);
}
...
static void __exit cpufreq_gov_dbs_exit(void)
{
	...
	cpufreq_unregister_governor(&cpufreq_gov_foxp);
}

MODULE_AUTHOR("Venkatesh Pallipadi <venkatesh.pallipadi@intel.com>");
MODULE_AUTHOR("Alexey Starikovskiy <alexey.y.starikovskiy@intel.com>");
MODULE_DESCRIPTION("'cpufreq_foxp' - A dynamic cpufreq governor for "
	"Low Latency Frequency Transition capable processors");
MODULE_LICENSE("GPL");

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_FOXP

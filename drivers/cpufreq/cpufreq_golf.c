/*
 *  drivers/cpufreq/cpufreq_golf.c
 *
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_GOLF
static struct cpufreq_governor cpufreq_gov_golf;
#endif
		...
		unsigned int new_rate)
{
	...
	for_each_online_cpu(cpu) {
		...
		if (!policy)
			continue;
		if (policy->governor != &cpufreq_gov_golf) {
...
static
#endif
struct cpufreq_governor cpufreq_gov_golf = {
	.name			= "golf",
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_golf);
}
...
static void __exit cpufreq_gov_dbs_exit(void)
{
	...
	cpufreq_unregister_governor(&cpufreq_gov_golf);
}
...
#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_GOLF

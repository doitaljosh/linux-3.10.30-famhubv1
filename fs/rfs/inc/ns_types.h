...
{	
	...
	MOUNT_CHKDSK				= 0x04000000,		/**< mount flag to perform chkdsk operation */
...
typedef FERROR (*PFN_VNODE_OPS_CLEAR_NODE) (
	IN  PVNODE                  pVnode);
...
struct _VNODE_OPERATIONS
{
	...
	PFN_VNODE_OPS_CLEAR_NODE        pfnClearNode;       /**< clear node interface */

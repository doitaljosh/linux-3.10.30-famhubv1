...
#define KDBUS_ITEM_NEXT(_i) (typeof(_i))((void*)(((u8 *)_i) + KDBUS_ALIGN8((_i)->size)))
#define KDBUS_ITEMS_SIZE(_h, _is) ((size_t)(_h)->size - offsetof(typeof(*_h), _is))

#define KDBUS_ITEMS_FOREACH(_i, _is, _s)				\
	for (_i = _is;							\
	     ((const u8 *)(_i) < (const u8 *)(_is) + (_s)) &&			\
	       ((const u8 *)(_i) >= (const u8 *)(_is));				\
	     _i = KDBUS_ITEM_NEXT(_i))

#define KDBUS_ITEM_VALID(_i, _is, _s)					\
	((_i)->size > KDBUS_ITEM_HEADER_SIZE &&				\
	 (const u8 *)(_i) + (_i)->size <= (const u8 *)(_is) + (_s) &&		\
	 (const u8 *)(_i) >= (const u8 *)(_is))

#define KDBUS_ITEMS_END(_i, _is, _s) \
	((const u8 *)_i == ((const u8 *)(_is) + KDBUS_ALIGN8(_s)))
...
({									\
	u64 __user *_sz =						\
		(u64 __user *)(((void __user *)(_b)) + offsetof(typeof(_t), size));	\
...
({									\
	u64 __user *_sz = (u64 __user *)(((void __user *)(_b)) + offsetof(_t, offset));	\
...
({									\
	size_t _max = (size_t)(_p)->size - offsetof(typeof(*(_p)), _s);		\
...
{
	size_t l = (size_t)item->size - KDBUS_ITEM_HEADER_SIZE;

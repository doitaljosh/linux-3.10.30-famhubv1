...
#ifdef SBB_SUPPORT
	/* destination name forwarded by SBB Agent */
	KDBUS_ITEM_SBB_DST_NAME,
	KDBUS_ITEM_SBB_BLOOM_FILTER,
#endif
...
#ifdef SBB_SUPPORT
enum kdbus_attach_for_sbb_flags {
	KDBUS_ATTACH_SBB_BLOOM_FILTER	=  1 <<  0,
};
#endif

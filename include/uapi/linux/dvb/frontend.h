...
struct dvb_frontend_parameters {
	__u32 frequency;     /* (absolute) frequency in Hz for all delivery system except SYS_DVBS, SYS_DVBS2 */
			             /* intermediate frequency in kHz for SYS_DVBS, SYS_DVBS2 */
...
#define DTV_MAX_COMMAND	DTV_STAT_SSI_MARGIN//DTV_STAT_SSI_MARGIN
...
// tuner get config
	...
	*/
	...
	/* 
		buf[0] = PLP List index (0 ~ num of mPLP ids)
		buf[1] = PLP ID
	*/
